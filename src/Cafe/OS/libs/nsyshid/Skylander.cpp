...
namespace nsyshid
{
	...
	const std::map<const std::pair<const uint16, const uint16>, const char*>
		s_listSkylanders = {
			...
			{{7, 0x1214}, "LightCore Rare Prism Break"},
			{{8, 0x0000}, "Sunburn"},
			{{9, 0x0000}, "Eruptor"},
			...
			{{23, 0x1814}, "Iridescent Wrecking Ball"},
			{{24, 0x0000}, "Camo"},
			{{24, 0x2805}, "Thorn Horn Camo"},
			{{25, 0x0000}, "Zook"},
			{{25, 0x1801}, "Series 2 Zook"},
			{{25, 0x1812}, "Stone Zook"},
			...
			{{27, 0x1814}, "White Flocked Stump Smash"},
			...
			{{103, 0x3801}, "Unreleased series 2 Flashwing"},
			{{104, 0x1206}, "Hot Head"},
			{{104, 0x1213}, "Sparkle/Glitter Hot Head"},
			{{105, 0x1000}, "Hot Dog"},
			{{105, 0x1015}, "Color Shift Hot Dog"},
			{{105, 0x1402}, "Molten Hot Dog"},
			{{105, 0x2805}, "Fire Bone Hot Dog"},
			{{105, 0x281A}, "Red Frito-Lay Hot Dog"},
			{{105, 0x281B}, "Green Frito-Lay Hot Dog"},
			{{105, 0x281C}, "Purple Frito-Lay Hot Dog"},
			{{106, 0x4096}, "Chill"},
			...
			{{218, 0x3018}, "Dark Dagger"},
			{{218, 0x3014}, "Shadow Spider"},
			{{218, 0x301A}, "Ghastly Grimace"},
			{{219, 0x3015}, "Shining Ship"},
			{{219, 0x300F}, "Heavenly Hawk"},
			{{219, 0x301B}, "Beam Scream"},
			{{220, 0x301E}, "Kaos Trap"},
			{{220, 0x341F}, "Ultimate Kaos Trap"},
			{{230, 0x3000}, "Hand of Fate"},
			{{230, 0x3403}, "Legendary Hand of Fate"},
			{{231, 0x3000}, "Piggy Bank"},
			{{232, 0x3000}, "Rocket Ram"},
			{{233, 0x3000}, "Tiki Speaky"},
			{{235, 0x5001}, "Bronze Mystery Chest"},
			{{235, 0x5002}, "Silver Mystery Chest"},
			{{235, 0x5003}, "Gold Mystery Chest"},
			{{235, 0x5017}, "Cursed Tiki Temple Mystery Chest"},
			{{235, 0x5019}, "Lost Imaginite Mines Chest"},
			...
			{{308, 0x3206}, "LightCore Midnight Museum"},
			{{310, 0x5000}, "Gryphon Park Observatory"},
			{{311, 0x5000}, "Enchanted Elven Forest"},
			...
			{{462, 0x3004}, "Unreleased Event Snap Shot"},
			{{462, 0x3402}, "Dark Snap Shot"},
			{{462, 0x340F}, "Instant Snap Shot"},
			{{463, 0x3000}, "Lob Star"},
			...
			{{615, 0x5021}, "Rock-Candy Pain-Yatta"},
			{{616, 0x5000}, "Mysticat"},
			{{617, 0x5000}, "Starcast"},
			{{617, 0x5021}, "Clear Starcast"},
			{{618, 0x5000}, "Buckshot"},
			{{618, 0x540C}, "Unreleased Heartbreaker Buckshot"},
			{{619, 0x5000}, "Aurora"},
			{{619, 0x5402}, "Solar Flare Aurora"},
			...
			{{1005, 0x2004}, "Gold Fire Kraken (Bottom)"},
			...
			{{1015, 0x2018}, "Color Shift Wash Buckler (Bottom)"},
			...
			{{2005, 0x2004}, "Gold Fire Kraken (Top)"},
			{{2005, 0x2402}, "Jade Fire Kraken (Top)"},
			{{2006, 0x2000}, "Stink Bomb (Top)"},
			{{2006, 0x2016}, "Silver Stink Bomb (Top)"},
			...
			{{2015, 0x2018}, "Color Shift Wash Buckler (Top)"},
			...
			{{3228, 0x440F}, "Instant Stealth Stinger"},
			{{3231, 0x4000}, "Dive Bomber"},
			{{3231, 0x4402}, "Spring Ahead Dive Bomber"},
			{{3231, 0x440F}, "Instant Dive Bomber"},
			{{3232, 0x4000}, "Sky Slicer"},
			{{3232, 0x440F}, "Instant Sky Slicer"},
			...
			{{3401, 0x4100}, "Patina High Volt"},
			{{3402, 0x4100}, "Splat"},
			{{3402, 0x4502}, "Power Blue Splat"},
			{{3406, 0x4100}, "Stormblade"},
			{{3406, 0x410E}, "Snow-Brite Stormblade"},
			...
			{{3423, 0x4100}, "Turbo Charge Donkey Kong (Nintendo Only)"},
			{{3423, 0x4502}, "Dark Turbo Charge Donkey Kong (Nintendo Only)"},
			{{3424, 0x4100}, "Hammer Slam Bowser (Nintendo Only)"},
